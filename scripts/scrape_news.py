...
新闻源（按优先级排序）：
1. arXiv quant-ph 预印本（学术前沿）
2. Physics World 量子频道（权威科普）
3. MIT Technology Review 量子计算标签
4. The Quantum Insider RSS（行业新闻聚合）
5. IBM Research Blog 量子频道
6. Google AI Blog 量子相关
7. Nature/Science RSS 量子相关

分类逻辑：
- breakthrough: 技术突破（新芯片、纠错里程碑、量子优越性等）
- industry: 产业投资（融资、合作、市场规模、商业化）
- policy: 政策战略（国家规划、标准发布、监管政策）

质量评分维度：
- 来源权威性权重（Nature/arXiv=5, 官方博客=4, 科技媒体=3, 聚合站=2）
...
QUANTUM_KEYWORDS = [
    ...
    "quantum sensor", "quantum communication", "quantum cryptography",
    "quantum key distribution", "quantum internet", "post-quantum",
    ...
    "topological quantum", "Bloch sphere",
    # 中文关键词
    "量子计算", "量子比特", "量子算法", "量子纠错", "量子优越",
    "量子霸权", "量子退火", "量子门", "量子纠缠", "量子通信",
    "量子密钥", "量子互联网", "量子模拟", "量子机器学习",
    "超导量子", "离子阱", "光量子", "中性原子", "拓扑量子",
]
    ...
    for source in FEED_SOURCES:
        ...
        for entry in entries:
            ...
            try:
                ...
                if (datetime.now() - news_date).days > 90:
                    continue
            except:
                pass
